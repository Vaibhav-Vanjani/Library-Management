...
function App() {
  ...
  useEffect(() => {
    ...
    if (location.pathname.includes("/admin") && !(loggedInUser?.isAdmin)) {
      redirect("/protected");
      return;
    }
  }, [location.pathname]);
      ...
      <Routes>
        <Route path="/" element={<Outlet />}>
          ...
          <Route path="/student" element={<Outlet />}>
            ...
            <Route
              path="/student/verifiedScan"
              element={<VerifiedScan />}
            ></Route>
          ...
          <Route path="/admin" element={<Outlet />}>
            ...
            <Route
              path="/admin/pendingPayment"
              element={<PendingPayment />}
            ></Route>
            <Route path="/admin/enroll" element={<Enroll />}></Route>
            <Route
              path="/admin/QRAdminListner"
              element={<QrAdminListener />}
            ></Route>
            <Route
              path="/admin/EntryExitView"
              element={<EntryExitView />}
            ></Route>
            <Route
